function FastConctacs(){
    ...
    return(
        <>
        <div className="max-md:w-full cursor-pointer flex flex-col gap-4 bg-slate-800/50 backdrop-blur-sm border-slate-700/50 border text-white rounded-2xl p-5 w-full h-full font-inter">
            <b className="text-xl">Contacto Rápido</b>
            <div className="flex gap-3 bg-[#34295c] border border-[#4C3E73] rounded-md p-2 w-auto h-auto">
            ...
            <div className="flex cursor-pointer gap-3 bg-[#34295c] border border-[#4C3E73] rounded-md p-2 w-auto h-auto">
            ...
            <div className="flex cursor-pointer gap-3 bg-[#34295c] border border-[#4C3E73] rounded-md p-2 w-auto h-auto" onClick={WindowGithub}>
