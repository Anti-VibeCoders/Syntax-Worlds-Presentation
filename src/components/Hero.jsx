...
function Hero() {
    ...
    return (
        <>
            <section ref={heroRef} className="hero-container relative h-[88dvh] overflow-hidden">
                <div className="code-card w-max h-max absolute left-30 top-40 p-3 rounded-lg flex items-center justify-center bg-purple-600/70 border-purple-400 border opacity-15 hover:scale-105 transition-all duration-200 cursor-pointer active:scale-100 float max-sm:top-15 max-sm:left-23">
                ...
                <div className="code-card w-max h-max absolute left-65 max-2xl:left-50 bottom-30 p-3 rounded-lg flex items-center justify-center bg-purple-600/70 border-purple-400 border opacity-15 hover:scale-105 transition-all duration-200 cursor-pointer active:scale-100 float max-sm:left-20 max-sm:bottom-10">
                ...
                <div className="world-card code-card w-max absolute right-22 top-32 opacity-15 h-max p-3 rounded-lg flex items-center justify-center bg-purple-600 border-purple-400 border hover:scale-105 transition-all duration-200 cursor-pointer active:scale-100 float reverse-float max-sm:top-5" onClick={() => {
                ...
                <div className="world-card code-card w-max absolute right-75 max-2xl:right-50 max-2xl:bottom-50 bottom-70 opacity-15 h-max p-3 rounded-lg flex items-center justify-center bg-purple-600 border-purple-400 border hover:scale-105 transition-all duration-200 cursor-pointer active:scale-100 float reverse-float max-lg:right-30 max-md:bottom-30 max-sm:bottom-20 max-sm:right-10">
                ...
                <div className="text-section flex flex-col items-center justify-center h-full">
                    <div className="badge flex items-center font-semibold gap-2 border-purple-500 border bg-purple-500/20 backdrop-blur-2xl rounded-full px-4 py-2 text-purple-200 cursor-pointer hover:-translate-y-0.5 transition-all duration-200 active:-translate-y-0 hover:border-purple-400 mb-4" onClick={() => {
                        window.open('https://discord.gg/9HYGt3WKVM', '_blank')
                    }}>
                    ...
                    <div className="title flex flex-col gap-6 items-center justify-center">
                        <h1 className="text-center text-8xl font-bold bg-gradient-to-r from-white via-purple-200 to-cyan-200 bg-clip-text text-transparent leading-1.2 max-2xl:text-7xl max-lg:text-6xl max-md:text-5xl max-sm:text-3xl">Desarrollo de Software <span className="block bg-gradient-to-r from-purple-400 to-purple-200 bg-clip-text text-transparent">a Medida</span></h1>
                        <div className="text flex flex-col gap-8">
                            <p className="text-xl max-w-[70ch] text-center text-gray-200 max-lg:px-4 max-sm:text-base">
                            ...
                            <div className="buttons flex justify-center gap-4 items-center max-sm:flex-col max-sm:items-center max-sm:justify-center">
                                <button
                                ...
                                <button className="bg-white text-purple-400 border border-purple-500 rounded-full w-max flex justify-center items-center h-max px-12 py-3 gap-4 cursor-pointer hover:bg-purple-300 transition-all duration-200 hover:text-white max-sm:w-[80%] max-sm:mx-auto"
                                    onClick={() => {
