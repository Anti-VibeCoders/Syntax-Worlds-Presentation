function ServicesCards({ serviceIcon, serviceTitle, iconClass, serviceDescription, className }) {
    return (
        <>
        <div className={`service-card ${className} flex flex-col bg-slate-800/50 backdrop-blur-sm border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105`}>
